...
class GitHub extends Controller\Controller {
    ...
    public function releases(\Base $f3){
        ...
        $releases = $f3->gitHubClient()->send('getProjectReleases', 'biekerudan/pathfinder', $releaseCount);
        ...
        foreach($releases as $key => &$release){
            ...
            $html = $f3->gitHubClient()->send('markdownToHtml', 'biekerudan/pathfinder', $body);
